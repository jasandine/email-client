EmailClient.EmailsRoute = Ember.Route.extend({
  beforeModel: function() {
    ...
    this.store.push('email', {
      ...
      desired location, within seconds the application will present a middle finger image to you along with a tagline of
      "What did you expect? REAL TIME?!?!LOLZ", early polling suggests this will be the most accurate real time device for our
      Trimet system."
    });
